...
import GirlsDressesData from "../../../../jsonfiles/girlsDresses.json";
import { ImStarFull } from "react-icons/im";
import { Button } from "flowbite-react";
import GirlsdressesFilter from "./Filters/filters";

const GirlsDresses = () => {
  let { girlsDresses } = GirlsDressesData;
  console.log(girlsDresses);
