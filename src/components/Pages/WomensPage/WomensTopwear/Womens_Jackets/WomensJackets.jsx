...
import JDATA from "../../../../jsonfiles/womenJackets.json";
import { ImStarFull } from "react-icons/im";
// import { Button } from "flowbite-react";
import WjacketFilter from "./Filters/filters";
              ...
              >
                ...
                <article>
                  ...
                  <div className="flex pl-2 mt-0.5">
                    ...
                    <span className="ml-2 mr-2 rounded bg-cyan-100 px-2.5 py-0.5 text-xs font-ComicNeue font-bold  text-cyan-800 dark:bg-cyan-800 dark:text-cyan-800">
                      {item.rating}
                    </span>
                  </div>
