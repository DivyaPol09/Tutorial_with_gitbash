...
import MensTrousersData from "../../../../jsonfiles/mensTrackpants.json";
import { ImStarFull } from "react-icons/im";
// import { Button } from "flowbite-react";
import MensTrousersFilter from "./Filters/filters";

const MensTrackpants = () => {
  let { menstrousers } = MensTrousersData;
  console.log(menstrousers);
          ...
          {menstrousers.map((item) => {
            return (
              ...
              >
                ...
                />
                <article>
                  <p className="text-lg tracking-tight text-gray-900 dark:text-white pb-1 pl-2 pt-2 mt-1 font-ComicNeue font-bold">
                    {" "}
                    {item.name}
                  </p>
